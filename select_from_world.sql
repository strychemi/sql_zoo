...
--8. USA, India, and China are big in population and big by area. Exclude these countries.
...
-- 10. Show the per-capita GDP for those countries with a GDP of at least one trillion (1000000000000; that is 12 zeros). Round this value to the nearest 1000.
